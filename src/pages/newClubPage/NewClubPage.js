      ...
      <div className="flex-container-chungus"> 
        <div className="flex-container-left">
          ...
          {organization.events.length > 0 ? (
            <div className="left-box">
              <p>Recruitment Timeline</p>
              {/*<EventAccord data={organization} />*/}
              {<RecruitmentTL data={organization} />}
              <div className="vl" style={{height: lineHeight + "vw"}}></div>
                
               {/* <RecruitmentEvent title="Infosession 1" start="5:30 PM PST" end="7:30 PM PST" passed={true} date="1/21" desc="yeah man we're gonna practice in the gym and do spikes and stuff holy guacamole man" />
                <div className="vl" style={{height: lineHeight + "vw"}}></div>
                <RecruitmentEvent title="Infosession 2" start="5:30 PM PST" end="7:30 PM PST"passed={false} date={"3/21"} desc="yeet yah testing values fjjfjfjf" />
