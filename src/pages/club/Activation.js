    ...
    <div className="activation">
      <div className="form">
        <div className="formGroup">
          ...
          <input
            className={
              recruiting.value === 1 ? 'userInput' : 'userInput hidden'
            }
            type="date"
            placeholder={
              appReq.value
        ...
        <div className="buttonWrapper">
          <button
            className={activated ? 'activatedButton' : 'inactivatedButton'}
            onClick={activate}>
            Activate Club
          </button>
        </div>
