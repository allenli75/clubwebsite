...
const RecrEvents = ({
  ...
  return (
    <div id="recr-main">
      ...
      <div className="admin-text">Add events related to recruitment!</div>
      ...
      <div style={{ minHeight: '70%' }}>
        {events.map((ev, i) => (
          <RecrAccord
            ...
            incNumEvents={incNumEvents}></RecrAccord>
        ))}
      </div>
      <div id="recr-buttons">
        <button className="recr-button" id="recr-add" onClick={(e) => addEv(e)}>
          + Add Event
        </button>
        <div className="recr-buttons-right">
          <button className="recr-button" id="recr-cancel" onClick={cancelEdit}>
            Cancel
          </button>
          <button className="recr-button" id="recr-save" onClick={saveAll}>
            Save
          </button>
        </div>
      </div>
